...
def run_pathmodel():
	...
	parser.add_argument("-p", "--picture", dest = "picture", metavar = "FILE", help = "Name of the picture result file (optional).")
	parser.add_argument("-o", "--output", dest = "output_file", metavar = "FILE", help = "Name of the result in this file (optional).")
	parser.add_argument("-i", "--intermediate", dest = "intermediate", action='store_true', help = "Add if you want the input file given to pathmodel after MZ Computation and Reaction Creation (optional).")
